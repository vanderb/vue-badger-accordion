...
import { openBlock, createBlock, renderSlot, createCommentVNode, createVNode, resolveDynamicComponent, createTextVNode } from 'vue';
...
const _hoisted_1 = {
  key: 0,
  ref: "badger",
  class: "js-badger-accordion"
};

function render(_ctx, _cache, $props, $setup, $data, $options) {
  return ($data.show)
    ? (openBlock(), createBlock("dl", _hoisted_1, [
...
script.__file = "src/components/BadgerAccordion.vue";
...
const _hoisted_1$1 = { class: "badger-accordion-item" };
const _hoisted_2 = { class: "badger-accordion__header" };
const _hoisted_3 = { class: "js-badger-accordion-header" };
const _hoisted_4 = { class: "badger-accordion-toggle" };
const _hoisted_5 = { class: "badger-accordion-title" };
const _hoisted_6 = /*#__PURE__*/createTextVNode("Collapse-Title");
const _hoisted_7 = { class: "badger-accordion__panel js-badger-accordion-panel" };
const _hoisted_8 = { class: "js-badger-accordion-panel-inner" };

function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createBlock("div", _hoisted_1$1, [
    createVNode("dt", _hoisted_2, [
      createVNode("div", _hoisted_3, [
        createVNode("button", _hoisted_4, [
          createVNode("span", _hoisted_5, [
            renderSlot(_ctx.$slots, "header", {}, () => [
              _hoisted_6
            ])
          ]),
          ($options.icon !== '' && $options.iconComponent)
            ? (openBlock(), createBlock(resolveDynamicComponent($options.iconComponent), {
                key: 0,
                opened: $data.opened,
...
script$1.__file = "src/components/BadgerAccordionItem.vue";

function install(Vue) {
  if (install.installed) return;
  install.installed = true;
  Vue.component('BadgerAccordion', script);
  Vue.component('BadgerAccordionItem', script$1);
...
var index = {
  BadgerAccordion: script,
  BadgerAccordionItem: script$1
};
